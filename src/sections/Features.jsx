    ...
    <section>
      <Element name="Features">
        <div className="container">
          <div
            className="relative flex md:flex-wrap
           flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
              ...
              <div
                ...
                <div className="w-full flex justify-start items-start">
                  <div className="-ml-3 mb-12 flex items-center justify-center flex-col">
                    ...
                    <img src={icon} alt="feature" className="size-28 object-contain" />
                  </div>
                </div>
                ...
                <li key={id} className="relative pt-16 px-4 pb-14">
                  ...
                  <div
                   ...
                   rounded-full hover:border-s4 transition-all duration-500 shadow-500 size-20">
                    <img src={icon} alt={title} className="siz-17/20 object-contain z-20" />
                  </div>
